  ...
  const renderStep = () => {
    switch (step) {
      case 1:
        return (
          <div className="space-y-4">
              ...
              {ageOptions.map((opt, i) => (
                <div
                  ...
                  className={`relative overflow-hidden cursor-pointer rounded-xl border-2 transition-all duration-300 hover:scale-[1.02] hover:shadow-md active:scale-[0.98] flex flex-col ${
                    answers[1] === opt.label ? "border-primary bg-accent shadow-sm" : "border-border bg-card hover:border-primary/40"
                  }`}
            ...
            <div className="mt-6 text-[10px] text-center text-muted-foreground/60 px-4" style={{ animation: "fadeInUp 0.4s ease-out 300ms both" }}>
              ...
              {bodyOptions.map((opt, i) => (
                <div
                  ...
                  className={`relative overflow-hidden cursor-pointer rounded-xl border-2 p-4 transition-all duration-300 hover:scale-[1.02] hover:shadow-md active:scale-[0.98] flex items-center gap-4 ${
                    answers[2] === opt.label ? "border-primary bg-accent shadow-sm" : "border-border bg-card hover:border-primary/40"
                  }`}
                  style={{ animation: `fadeInUp 0.4s ease-out ${i * 80}ms both` }}
                >
                  <img src={opt.img} alt={opt.label} className="w-28 h-28 sm:w-36 sm:h-36 object-contain flex-shrink-0 drop-shadow-sm" loading="lazy" width={512} height={512} />
                  ...
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all duration-300 flex-shrink-0 ${answers[2] === opt.label ? "border-primary bg-primary" : "border-muted-foreground/30"}`}>
                    {answers[2] === opt.label && (
      ...
      case 3:
        return (
          <div className="space-y-6 text-center">
            ...
            <button onClick={() => goNext()} className="w-full py-3.5 rounded-xl bg-primary text-primary-foreground font-semibold text-base transition-all duration-300 hover:brightness-110 active:scale-[0.98] animate-pulse-slow" style={{ animation: "fadeInUp 0.4s ease-out 300ms both" }}>
              Continuar
            </button>
          </div>
        );
      ...
      case 4:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>Elige tus objetivos</h2>
            <p className="text-xs text-muted-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out 100ms both" }}>Selecciona todos los que apliquen</p>
            <MultiSelect options={["Durar más en la cama", "Orgasmos más intensos", "Erecciones más firmes"]} selected={answers[4] || []} onChange={(v) => setAnswers((p) => ({ ...p, [4]: v }))} />
            {(answers[4]?.length > 0) && (
              <button onClick={() => goNext()} className="w-full py-3.5 rounded-xl bg-primary text-primary-foreground font-semibold transition-all hover:brightness-110 active:scale-[0.98]" style={{ animation: "fadeInUp 0.3s ease-out both" }}>Continuar</button>
            )}
          </div>
        );
        ...
        return (
          <div className="space-y-6 text-center">
            <div className="space-y-4" style={{ animation: "fadeInUp 0.4s ease-out both" }}>
              <p className="font-bold text-foreground text-lg leading-snug">Tu capacidad de durar más tiempo proviene de la fuerza y salud de los músculos del suelo pélvico.</p>
              <p className="font-bold text-foreground text-lg leading-snug">Y cuanto más envejeces, más débil se vuelve tu músculo masculino.</p>
              <p className="font-bold text-foreground text-lg leading-snug">Músculos fuertes te ayudan a tener erecciones duras de nuevo, controlar la eyaculación y durar más en la cama.</p>
            </div>
            ...
            <button onClick={() => goNext()} className="w-full py-3.5 rounded-xl bg-primary text-primary-foreground font-semibold text-base transition-all duration-300 hover:brightness-110 active:scale-[0.98] animate-pulse-slow" style={{ animation: "fadeInUp 0.4s ease-out 300ms both" }}>Continuar</button>
          </div>
        );
      ...
      case 6:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Cuánto tiempo, en promedio, dura tu relación sexual?</h2>
      ...
      case 7:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Con qué frecuencia experimentas eyaculación precoz?</h2>
      ...
      case 8:
        return (
          <div className="space-y-6">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Cuál es tu nivel de dificultad para controlar durante el sexo?</h2>
      ...
      case 9:
        return (
          <div className="space-y-6">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Cuál es tu nivel de dificultad para controlar durante la masturbación?</h2>
      ...
      case 10:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Cuánto tiempo te gustaría durar?</h2>
      ...
      case 11:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Has hecho algún tipo de entrenamiento para el suelo pélvico?</h2>
      ...
      case 12:
        return (
          <div className="space-y-6 text-center">
            <div className="space-y-4" style={{ animation: "fadeInUp 0.4s ease-out both" }}>
              <p className="font-bold text-foreground text-xl leading-snug">El programa de Ejercicios de Nexor MEN ayuda a fortalecer los músculos del suelo pélvico y puede aumentar el tiempo promedio de relación hasta 7 veces</p>
            </div>
      ...
      case 13:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Cómo está la fuerza de tu erección?</h2>
      ...
      case 14:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Hace cuánto tiempo tienes estas dificultades?</h2>
      ...
      case 15:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Con qué frecuencia tienes erecciones matutinas?</h2>
      ...
      case 16:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Tienes dificultad para lograr una erección antes del sexo?</h2>
            {["Siempre", "Con frecuencia", "Raramente", "Nunca"].map((opt, i) => (
      ...
      case 17:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Puedes tener sexo dos veces seguidas?</h2>
      ...
      case 18:
        return (
          <div className="space-y-6 text-center">
            <div className="space-y-4" style={{ animation: "fadeInUp 0.4s ease-out both" }}>
              <p className="font-bold text-foreground text-xl leading-snug">La calidad de la erección está directamente relacionada con la fuerza de los músculos del suelo pélvico.</p>
            </div>
            <div style={{ animation: "fadeInUp 0.4s ease-out 150ms both" }}>
            ...
            <div className="space-y-3" style={{ animation: "fadeInUp 0.4s ease-out 250ms both" }}>
              <p className="text-sm text-foreground leading-relaxed">Uno de los tres músculos principales de esta región, esencial para la salud sexual masculina, <strong>es el músculo bulbocavernoso</strong>.</p>
              <p className="text-sm text-foreground leading-relaxed">Permite que el pene se llene de sangre y mantenga la firmeza.</p>
            </div>
            <button onClick={() => goNext()} className="w-full py-3.5 rounded-xl bg-primary text-primary-foreground font-semibold text-base transition-all duration-300 hover:brightness-110 active:scale-[0.98] animate-pulse-slow" style={{ animation: "fadeInUp 0.4s ease-out 350ms both" }}>Continuar</button>
          </div>
        );
          ...
          <EducativeSlide
            ...
            visual={
              <div className="bg-accent rounded-2xl p-5 text-left space-y-3">
                ...
                <p className="text-sm text-foreground italic">"Después de 3 semanas siguiendo el plan, mi confianza cambió por completo. Puedo durar mucho más y mi pareja notó la diferencia. Lo recomiendo a ojos cerrados."</p>
      ...
      case 20:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Cómo es tu día a día?</h2>
            {[
      ...
      case 21:
        return (
          <div className="space-y-6">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Cuál es tu nivel de estrés diario?</h2>
      ...
      case 22:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Cuál es tu nivel de actividad física?</h2>
      ...
      case 23:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Cuántas horas al día frente a pantallas?</h2>
      ...
      case 24:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Cuál es tu frecuencia de consumo de pornografía?</h2>
      ...
      case 25:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Cuáles de estos hábitos son parte de tu rutina?</h2>
            <p className="text-xs text-muted-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out 100ms both" }}>Selecciona todos los que apliquen</p>
            <MultiSelect options={["Fumar", "Consumo de alcohol", "Consumo de dulces", "Fast Food", "Ninguno de los anteriores"]} selected={answers[25] || []} onChange={(v) => setAnswers((p) => ({ ...p, [25]: v }))} />
            {(answers[25]?.length > 0) && (
              <button onClick={() => goNext()} className="w-full py-3.5 rounded-xl bg-primary text-primary-foreground font-semibold transition-all hover:brightness-110 active:scale-[0.98]" style={{ animation: "fadeInUp 0.3s ease-out both" }}>Continuar</button>
            )}
          </div>
      ...
      case 26:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Cuál es tu estado civil?</h2>
      ...
      case 27:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Tu desempeño sexual es motivo de preocupación en tus relaciones?</h2>
      ...
      case 28:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Cuál es tu frecuencia sexual mensual?</h2>
      ...
      case 29:
        return (
          <div className="space-y-6">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Cómo está tu libido en los últimos 3 meses?</h2>
      ...
      case 30:
        return (
          <div className="space-y-4">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>¿Has intentado soluciones de efecto rápido (pastillas, sprays, etc.)?</h2>
      ...
      case 31:
        return (
          <div className="space-y-5">
            <h2 className="text-lg font-bold text-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out both" }}>Ingresa tu primer nombre para personalizar tu plan</h2>
            <p className="text-sm text-muted-foreground text-center" style={{ animation: "fadeInUp 0.4s ease-out 100ms both" }}>Tu plan será preparado exclusivamente para ti</p>
        ...
        return (
          <div className="space-y-6 text-center">
            ...
            <div className="space-y-3" style={{ animation: "fadeInUp 0.4s ease-out 100ms both" }}>
              <h2 className="text-xl font-bold text-foreground leading-snug">Basado en décadas de investigación científica</h2>
              <p className="text-sm text-muted-foreground leading-relaxed">Nuestro método está fundamentado en estudios de las mejores universidades del mundo sobre salud sexual masculina y fortalecimiento del suelo pélvico.</p>
            </div>
            <div style={{ animation: "fadeInUp 0.4s ease-out 200ms both" }}>
